...
public class PriceCalculatorService : IPriceCalculatorService
{
    ...
    {
        if (goods.Any()) throw new ArgumentException("Список товаров пустой");
    ...
    {
        if (take <= 0) throw new ArgumentOutOfRangeException(nameof(take), take, "Take должно быть больше нуля");
